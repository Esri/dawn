...
files {
  ...
  "src/tint/lang/wgsl/common/common.cc",
  ...
  "src/tint/utils/bytes/writer.cc",
...
if (enable_msl) then
  ...
  files {
    ...
    "src/tint/lang/msl/writer/ast_printer/ast_printer.cc",
    ...
    "src/tint/lang/msl/writer/output.cc",
    "src/tint/lang/msl/writer/writer.cc",
  }
