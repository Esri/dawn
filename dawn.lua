...
files {
  ...
  "src/tint/lang/wgsl/builtin_fn.cc",
  ...
  "src/tint/lang/wgsl/intrinsic/ctor_conv.cc",
  "src/tint/lang/wgsl/intrinsic/data.cc",
  "src/tint/lang/wgsl/ir/builtin_call.cc",
  "src/tint/lang/wgsl/ir/unary.cc",
  ...
  "src/tint/lang/wgsl/sem/array.cc",
  ...
  "src/tint/lang/wgsl/writer/raise/value_to_let.cc",
  ...
  "src/tint/utils/bytes/reader.cc",
...
if (enable_glsl) then
  ...
  files {
    ...
    "src/tint/lang/glsl/writer/output.cc",
    "src/tint/lang/glsl/writer/writer.cc",
    "src/tint/lang/glsl/writer/ast_printer/ast_printer.cc",
    ...
    "src/tint/lang/glsl/writer/common/options.cc",
...
if (enable_hlsl) then
  ...
  files {
    ...
    "src/tint/lang/hlsl/writer/output.cc",
...
if (enable_msl) then
  ...
  files {
    ...
    "src/tint/lang/msl/builtin_fn.cc",
    "src/tint/lang/msl/intrinsic/data.cc",
    "src/tint/lang/msl/ir/binary.cc",
    "src/tint/lang/msl/ir/builtin_call.cc",
    ...
    "src/tint/lang/msl/writer/common/options.cc",
    "src/tint/lang/msl/writer/common/output.cc",
    ...
    "src/tint/lang/msl/writer/raise/builtin_polyfill.cc",
