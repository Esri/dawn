...
files {
  ...
  "src/dawn/native/d3d11/BackendD3D11.cpp",
  "src/dawn/native/d3d11/BindGroupD3D11.cpp",
  "src/dawn/native/d3d11/BindGroupLayoutD3D11.cpp",
  "src/dawn/native/d3d11/BindGroupTrackerD3D11.cpp",
  "src/dawn/native/d3d11/BufferD3D11.cpp",
  "src/dawn/native/d3d11/CommandBufferD3D11.cpp",
  "src/dawn/native/d3d11/CommandRecordingContextD3D11.cpp",
  "src/dawn/native/d3d11/ComputePipelineD3D11.cpp",
  "src/dawn/native/d3d11/D3D11Backend_rtc_shim_1.cpp",
  "src/dawn/native/d3d11/D3D11Backend_rtc_shim_1.cpp",
  "src/dawn/native/d3d11/DeviceD3D11.cpp",
  "src/dawn/native/d3d11/DeviceInfoD3D11.cpp",
  "src/dawn/native/d3d11/PhysicalDeviceD3D11.cpp",
  "src/dawn/native/d3d11/PipelineLayoutD3D11.cpp",
  "src/dawn/native/d3d11/PlatformFunctionsD3D11.cpp",
  "src/dawn/native/d3d11/QuerySetD3D11.cpp",
  "src/dawn/native/d3d11/QueueD3D11.cpp",
  "src/dawn/native/d3d11/RenderPipelineD3D11.cpp",
  "src/dawn/native/d3d11/SamplerD3D11.cpp",
  "src/dawn/native/d3d11/ShaderModuleD3D11.cpp",
  "src/dawn/native/d3d11/SharedFenceD3D11.cpp",
  "src/dawn/native/d3d11/SharedTextureMemoryD3D11.cpp",
  "src/dawn/native/d3d11/SwapChainD3D11.cpp",
  "src/dawn/native/d3d11/TextureD3D11.cpp",
  "src/dawn/native/d3d11/UtilsD3D11.cpp",
  ...
  "src/tint/lang/core/ir/access_rtc_shim_1.cc",
  ...
  "src/tint/lang/core/subgroup_matrix_kind.cc",
  ...
  "src/tint/lang/core/type/subgroup_matrix.cc",
  ...
  "src/tint/lang/wgsl/ast/attribute_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/ast/clone_context_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/ast/row_major_attribute.cc",
  ...
  "src/tint/lang/wgsl/ast/transform/add_empty_entry_point_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/array_length_from_uniform_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/binding_remapper_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/builtin_polyfill_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/canonicalize_entry_point_io.cc",
  "src/tint/lang/wgsl/ast/transform/data_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/demote_to_helper_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/direct_variable_access_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/ast/transform/manager_rtc_shim_2.cc",
  "src/tint/lang/wgsl/ast/transform/multiplanar_external_texture_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/preserve_padding_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/ast/transform/remove_continue_in_switch_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/ast/transform/robustness_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/simplify_pointers.cc",
  "src/tint/lang/wgsl/ast/transform/single_entry_point_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/ast/transform/vertex_pulling_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/transform/zero_init_workgroup_memory_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ast/type_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/builtin_fn_rtc_shim_1.cc",
  "src/tint/lang/wgsl/diagnostic_rule.cc",
  "src/tint/lang/wgsl/diagnostic_severity.cc",
  "src/tint/lang/wgsl/extension_rtc_shim_1.cc",
  ...
  "src/tint/lang/wgsl/intrinsic/data_rtc_shim_2.cc",
  "src/tint/lang/wgsl/ir/builtin_call_rtc_shim_1.cc",
  "src/tint/lang/wgsl/ir/unary_rtc_shim_1.cc",
  "src/tint/lang/wgsl/language_feature.cc",
  "src/tint/lang/wgsl/program/clone_context_rtc_shim_2.cc",
  ...
  "src/tint/lang/wgsl/sem/builtin_fn_rtc_shim_2.cc",
...
if (enable_glsl) then
  ...
  files {
    ...
    "src/tint/lang/glsl/writer/output_rtc_shim_1.cc",
    "src/tint/lang/glsl/writer/writer_rtc_shim_1.cc",
    "src/tint/lang/glsl/writer/ast_printer/ast_printer_rtc_shim_1.cc",
    ...
    "src/tint/lang/glsl/writer/common/options_rtc_shim_1.cc",
    "src/tint/lang/glsl/writer/common/printer_support.cc",
    "src/tint/lang/glsl/writer/printer/printer.cc",
    "src/tint/lang/glsl/writer/raise/raise_rtc_shim_1.cc",
  }
...
if (enable_spirv) then
  ...
  files {
    ...
    "src/tint/lang/spirv/validate/validate_rtc_shim_3.cc",
...
if (enable_d3d12) then -- or d3d11
  ...
  files {
    ...
    "src/dawn/native/d3d/BackendD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/BlobD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/D3DBackend_rtc_shim_1.cpp",
    "src/dawn/native/d3d/D3DBackend_rtc_shim_1.cpp",
    "src/dawn/native/d3d/D3DError_rtc_shim_1.cpp",
    "src/dawn/native/d3d/DeviceD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/KeyedMutex_rtc_shim_1.cpp",
    "src/dawn/native/d3d/PhysicalDeviceD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/PlatformFunctions_rtc_shim_1.cpp",
    "src/dawn/native/d3d/QueueD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/ShaderUtils_rtc_shim_1.cpp",
    "src/dawn/native/d3d/SharedFenceD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/SharedTextureMemoryD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/SwapChainD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d/UtilsD3D_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/BackendD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/BindGroupD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/BindGroupLayoutD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/BufferD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/CPUDescriptorHeapAllocationD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/CommandBufferD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/CommandRecordingContext_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/ComputePipelineD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/D3D12Backend_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/D3D12Backend_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/D3D12Info_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/DeviceD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/GPUDescriptorHeapAllocationD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/HeapAllocatorD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/HeapD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/PageableD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/PhysicalDeviceD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/PipelineLayoutD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/PlatformFunctionsD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/QuerySetD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/QueueD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/RenderPassBuilderD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/RenderPipelineD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/ResidencyManagerD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/ResourceAllocatorManagerD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/ResourceHeapAllocationD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/SamplerD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/SamplerHeapCacheD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/ShaderModuleD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/ShaderVisibleDescriptorAllocatorD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/SharedBufferMemoryD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/SharedFenceD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/SharedTextureMemoryD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/StagingDescriptorAllocatorD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/StreamImplD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/SwapChainD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/TextureCopySplitter_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/TextureD3D12_rtc_shim_1.cpp",
    "src/dawn/native/d3d12/UtilsD3D12_rtc_shim_1.cpp",
